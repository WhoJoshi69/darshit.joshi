...
const Footer = async () => {
    const repoStats = await fetch(
        'https://api.github.com/repos/WhoJoshi69/darshit.joshi',
        {
            next: {
    ...
    return (
        <footer className="text-center pb-5" id="contact">
            <div className="container">
                ...
                <div className="">
                    <a
                        href="https://github.com/WhoJoshi69/darshit.joshi"
                        target="_blank"
                        className="leading-none text-muted-foreground hover:underline hover:text-white"
                    >
                        Design & built by Darshit Joshi
                    ...
                    {/* Note: If you are not Darshit, use this copyright message instead */}
                    {/* <a href='https://www.me.toinfinite.dev/' className="leading-none text-muted-foreground hover:underline hover:text-white">
                        Design & built by Darshit Joshi <br />
                        Revised by Darshit Joshi
